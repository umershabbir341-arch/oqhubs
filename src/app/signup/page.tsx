    ...
    return (
        <main className="min-h-screen p-4 flex flex-col items-center justify-center relative overflow-hidden bg-white text-black">
            ...
            <div className="absolute top-0 left-0 w-full h-full -z-10">
                <div className="absolute top-1/4 -right-20 w-96 h-96 bg-black/[0.03] rounded-full blur-[120px]" />
                <div className="absolute bottom-1/4 -left-20 w-96 h-96 bg-zinc-200/50 rounded-full blur-[120px]" />
            </div>
