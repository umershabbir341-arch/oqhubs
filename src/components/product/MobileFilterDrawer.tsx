            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed top-0 right-0 bottom-0 w-full max-w-[340px] bg-white z-[1000] flex flex-col shadow-2xl"
                    >
                        {/* Header */}
                        <div className="flex items-center justify-between p-6 border-b border-neutral-100">
                            <h2 className="text-xl font-black uppercase tracking-tight">Filters</h2>
                            <button onClick={onClose} className="p-2 -mr-2 text-neutral-400 hover:text-black">
                                <X size={24} />
                            </button>
                        </div>
